...
import ReservationHistoryOfGuest from '../views/reservation/ReservationHistoryOfGuest.vue';
...
const routes: RouteRecordRaw[] = [
    ...
    { path: `/reservation/history`, component: ReservationHistoryOfGuest, meta: { role: [UserRole.Guest] } },
];
